...
\section{From linear logic to intuitionistic logic}
\label{sec:logic}
...
This works, but seems somewhat \textit{ad hoc}.
A more categorically principled approach (which turns out to solve the problem in roughly the same way) is to use the multi-cut as in \cref{thm:monpos-multicutadm}.
