...
In a monoidal category we can consider judgments with multiple outputs as well as multiple inputs.\footnote{[Caveat: I haven't seen quite this sort of type theory ever written down before; I'm envisioning it as like ``classical linear logic'' but allowing cut along multiple formulas at once.]}
...
\chapter{Classical logic, linear logic, polycategories, and PROPs}
\label{chap:polycats}
