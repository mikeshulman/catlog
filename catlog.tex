...
\date{\today}
\makeatletter
\autodefs{\bSet\bMag\bVect\bPoset\bRelGr\bCat\bGr\bmSLat\ftype\bPrCat\bCoprCat\bMCat\bRepMCat\bMGr\bMPos\bRelMGr\bMonPos\bMonCat\bSMPos\bSMC\bProp\bTV\bHeyting\fapp\bTh}
\autodefs{\nAut\nShuf}
\def\tv{\mathbf{2}}
\def\tr{\mathrm{tr}}
\let\sect\section
