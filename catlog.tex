...
Other systems of formal logic, such as ``Hilbert-style calculi'' (see \cref{ex:hilbert-calculus}), though they can derive the same class of tautologies, do not really include hypothetical reasoning as such, and hence do not model informal reasoning as well.
...
\begin{ex}\label{ex:hilbert}
  ...
  (The main reason for using a Hilbert system seems to be that it \emph{never} changes the context.
  This makes certain metatheoretic arguments easier, but at the cost of greater distance from informal mathematics, since as we have remarked the latter gives a central place to hypothetical reasoning.
...
\begin{rmk}
  ...
  Most authors who attempt to take structural rules as primitive actually do use the same term for both of these, essentially making the structural rules invisible in terms.
  ...
  This is difficult and tedious, and hence often left to the reader or left unmentioned altogether.
