...
\begin{equation}\label{princ:independence}
  {Each rule in a type theory should refer to only one operation}.\tag{$\ast$}
\end{equation}
...
\begin{equation}\label{princ:ump}
  The operations in a type theory should correspond categorically to objects with universal properties.\tag{$\dagger$}
\end{equation}
