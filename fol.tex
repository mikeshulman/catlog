...
% TODO: Give some details of this.  For equality, we can allow the proof of $\ph[x/y]$ to discharge any number of hypotheses of the form $\theta[x/y]$ as long as $\theta[M/x,N/y]$ is elsewhere a hypothesis (or is added as a hypothesis by the equality rule).

% TODO: Give some examples of informal reasoning and how it translates to formal deduction.  One de Morgan's law for quantifiers?  Or Frobenius \cref{ex:exists-frob}?
