...
One origin of Heyting categories is explored in \cref{ex:lccc}.
...
\begin{ex}\label{ex:lccc}
  ...
  \item If \cS has all finite limits that are stable under pullback, then it is a coherent category.
  \item If \cS has all finite limits and is locally cartesian closed, then it is a Heyting category.
  \end{enumerate}
\end{ex}
